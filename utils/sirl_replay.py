...
SIRL_METRIC_KEYS = (
    ...
    "no_foot_contact",
    "moving_no_foot_contact",
    "moving_support_contact_loss",
    "moving_planted_contact_deficit",
    "low_speed_no_foot_contact",
    "low_speed_support_contact_loss",
    "support_front_lag",
    "support_front_pitch_lag",
    "swing_foot_forward_lag",
    "swing_pair_forward_lag",
    "low_speed_swing_pair_forward_lag",
    "root_feet_lateral_diff",
    "straight_path_lateral",
    "straight_heading",
    "straight_lateral_vel",
    "straight_yaw_vel",
    "low_speed_overspeed",
    ...
    "sustain_right_forward_pitch_push",
    "sustain_ankle_tracking",
    "sustain_yaw_drift",
    "sustain_swing_clearance_excess",
    "sustain_no_foot_contact",
    "sustain_support_front_lag",
    "sustain_support_front_pitch_lag",
    "sustain_swing_foot_forward_lag",
    "sustain_swing_pair_forward_lag",
    "sustain_root_feet_lateral_diff",
    "base_tilt",
    "low_height",
    "stand_drift",
    "stand_forward_pitch",
    "stand_planted_contact_deficit",
    "stop_transition_drift",
    "stop_transition_forward_pitch",
    "stop_transition_no_foot_contact",
    "command_transition_drift",
