...
from holosoma.config_values.loco.k1.reward import k1_12dof_loco, k1_12dof_loco_fast_sac
...
REWARD_REGISTRY.add("k1_12dof_loco", k1_12dof_loco)
REWARD_REGISTRY.add("k1_12dof_loco_fast_sac", k1_12dof_loco_fast_sac)
