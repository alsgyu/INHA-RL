...
from holosoma.config_values.loco.k1.action import k1_12dof_joint_pos as _k1_12dof_joint_pos
...
k1_12dof_joint_pos = ACTION_REGISTRY.add("k1_12dof_joint_pos", _k1_12dof_joint_pos)
